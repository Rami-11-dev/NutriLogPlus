...
fun RecipeTopBar(
    ...
    CenterAlignedTopAppBar(
        ...
        title = {
            AnimatedContent(
                targetState = isNewRecipe,
                transitionSpec = { fadeIn() togetherWith fadeOut() }
            ) { targetIsNew ->
                Text(
                    text = if (targetIsNew) stringResource(R.string.recipe_new_title)
                    else stringResource(R.string.recipe_edit_title),
...
@Composable
private fun RecipeTopBarPreview() {
