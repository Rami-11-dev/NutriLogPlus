            ...
            Button(
                ...
                if (isLoading) {
                    ...
                    Row(
                        ...
                        Icon(
                            imageVector = if (isNewEntry) Icons.Rounded.Add else Icons.Rounded.Done,
                            contentDescription = null
                        )
                        Spacer(Modifier.width(12.dp))
                        Text(
                            text = if (isNewEntry) stringResource(R.string.add_meal_entry_str)
...
@Composable
private fun MealEntryBottomActionBarPreview() {
